...
Connection cn = DriverManager.getConnection("jdbc:odbc:utsaha17");
 ...
 PreparedStatement psss = cn.prepareStatement("select count(*) from participantdetails  ");
...
Connection cnn = DriverManager.getConnection("jdbc:odbc:utsaha17");
 PreparedStatement ps = cnn.prepareStatement("select * from participantdetails  order by id ");
...
<tr><td colspan="8">Totalnumber of registered participants</td><td colspan="5 " ><%=num%></td></tr>
